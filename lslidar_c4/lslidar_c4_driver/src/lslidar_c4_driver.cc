...
LslidarC4Driver::LslidarC4Driver(
...
bool LslidarC4Driver::loadParameters() {
...
bool LslidarC4Driver::createRosIO() {

  // ROS diagnostics
  diagnostics.setHardwareID("Lslidar_C4");
  // c4 publishs 20*16 thousands points per second.
  ...
  ROS_INFO("expected frequency: %.3f (Hz)", diag_freq);
    ...
    // Output
    packet_pub = nh.advertise<lslidar_c4_msgs::LslidarC4Packet>(
                "lslidar_packet", 100);
    return true;
}

bool LslidarC4Driver::openUDPPort() {
...
bool LslidarC4Driver::initialize() {
    ...
    ROS_INFO("Initialised lslidar c4 without error");
    return true;
}

int LslidarC4Driver::getPacket(
        lslidar_c4_msgs::LslidarC4PacketPtr& packet) {
...
void LslidarC4Driver::initTimeStamp(void)
{
    int i;
...
void LslidarC4Driver::getFPGA_GPSTimeStamp(lslidar_c4_msgs::LslidarC4PacketPtr &packet)
{
